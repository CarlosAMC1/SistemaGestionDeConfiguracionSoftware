...
using static SistemaGestionDeConfiguracionSoftware.Models.Extras.Filtros;
...
namespace SistemaGestionDeConfiguracionSoftware.Controllers
{
    ...
    {
        ClsMetodologia metodologia = new ClsMetodologia();
        ...
        public ActionResult Guardar(ClsMetodologia metodologia)
        {
        ...
        {
            return View(id == 0 ? new ClsMetodologia() : metodologia.ObtenerMetodologia(id));
        }
